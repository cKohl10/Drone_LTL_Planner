...
enum class RADIO_RC_CHANNELS_FLAGS : uint8_t
{
    FAILSAFE=1, /* Failsafe is active. | */
    FRAME_MISSED=2, /* Indicates that the current frame has not been received. Channel values are frozen. | */
};
...
enum class RADIO_LINK_STATS_FLAGS : uint8_t
{
    RSSI_DBM=1, /* Rssi are in negative dBm. Values 0..254 corresponds to 0..-254 dBm. | */
};

//! RADIO_LINK_STATS_FLAGS ENUM_END
constexpr auto RADIO_LINK_STATS_FLAGS_ENUM_END = 2;
...
#include "./mavlink_msg_radio_link_stats.hpp"
